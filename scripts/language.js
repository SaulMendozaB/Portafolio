...
const translations = {
  ES: {
    ...
    seinpro: 'SeinPro: Sitio web creado con WordPress para un cliente con negocio en el sector ganadero.',
  ...
  EN: {
    ...
    seinpro: 'SeinPro: Website created with WordPress for a client with a business in the livestock sector.',
